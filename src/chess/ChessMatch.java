...
public class ChessMatch {
	...
	public boolean[][] possibleMoves(ChessPosition sourcePosition) {
		Position position = sourcePosition.toPosition(sourcePosition.getRow(), sourcePosition.getColumn());
	...
	public void validateSourcePosition(Position source) {
		if (!board.thereIsAPiece(source))
			throw new ChessException("error: piece not found");
		if (!board.piece(source).isThereAnyPossibleMove())
			throw new ChessException("error: there is no possible moves for this piece");
		if (currentPlayer != ((ChessPiece) board.piece(source)).getColor())
			throw new ChessException("You can't choose your opponent's pieces");
	}

	public void validadeTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target))
			throw new ChessException("error: piece can't move  to target position");
	}
